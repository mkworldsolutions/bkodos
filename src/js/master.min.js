...
var _LandingA1Mod = __webpack_require__(27);

var _LandingA1Mod2 = _interopRequireDefault(_LandingA1Mod);

var _References = __webpack_require__(28);

var _References2 = _interopRequireDefault(_References);

var _CaseStudies = __webpack_require__(29);
...
(function () {
    ...
    if (menu !== null) {
        (0, _reactDom.render)(_react2.default.createElement(_Menu2.default, null), menu);
    }
    // render A1 mod
    var landingA1Mod = document.getElementById('landing-a1-mod');
    if (landingA1Mod !== null) {
        (0, _reactDom.render)(_react2.default.createElement(_LandingA1Mod2.default, null), landingA1Mod);
    }
    // render references
    var references = document.getElementById('references');
    if (references !== null) {
        (0, _reactDom.render)(_react2.default.createElement(_References2.default, null), references);
    }
    // render case studies
    var caseStudy = document.getElementById('case-study');
    if (caseStudy !== null) {
        (0, _reactDom.render)(_react2.default.createElement(_CaseStudies2.default, null), caseStudy);
    }
})();
...
var Menu = function (_Component) {
    ...
    _createClass(Menu, [{
        ...
        value: function render() {
            return _react2.default.createElement('div', { className: 'menu-container clear' }, _react2.default.createElement('div', { className: 'logo-wrapper' }, _react2.default.createElement('a', { className: 'logo-link', href: '#' }, _react2.default.createElement('img', { className: 'logo-img', src: '/images/logo.jpg', alt: 'BK' }))), _react2.default.createElement('div', { className: 'menu-wrapper' }, _react2.default.createElement('ul', { className: 'menu clear' }, _react2.default.createElement('li', { className: 'menu-item' }, _react2.default.createElement('a', { className: 'menu-link', href: '#' }, 'Work')), _react2.default.createElement('li', { className: 'menu-item' }, _react2.default.createElement('a', { className: 'menu-link', href: '#' }, 'About')), _react2.default.createElement('li', { className: 'menu-item' }, _react2.default.createElement('a', { className: 'menu-link', href: '#' }, 'Contact')))));
        }
    }]);
...
var LandingA1Mod = function LandingA1Mod() {
    return _react2.default.createElement('div', { className: 'landing-mod-container' }, _react2.default.createElement('div', { className: 'landing-text-wrapper' }, _react2.default.createElement('div', { className: 'landing-text' }, 'Solving Problems'), _react2.default.createElement('div', { className: 'landing-text' }, _react2.default.createElement('span', { className: 'landing-text-underline' }, 'Designing'), ' Solutions')));
};

exports.default = LandingA1Mod;
...
var References = function (_Component) {
    _inherits(References, _Component);
    ...
    function References(props) {
        ...
        var referencePerPage = 2; // FIX ME - find page width to determine how many to show per page
        _this.state = {
            referenceLoaded: false,
            referenceData: {},
            referencesCount: 0,
            page: 1,
            referencePerPage: referencePerPage,
            totalPages: 0
        ...
        xReq.onload = function () {
            if (xReq.readyState === 4) {
                if (xReq.status === 200) {
                    _this.renderReferences(xReq.responseText);
                } else {
    ...
    _createClass(References, [{
        ...
        value: function render() {
            var _state = this.state,
                referenceLoaded = _state.referenceLoaded,
                referenceData = _state.referenceData,
                referencePerPage = _state.referencePerPage,
                page = _state.page;
            ...
            // lazy load hack
            var startIndex = (page - 1) * referencePerPage;
            var endIndex = startIndex + referencePerPage;
            var referenceToLoad = referenceData.slice(startIndex, endIndex);

            return _react2.default.createElement("div", { className: "references-container clear" }, _react2.default.createElement("div", { className: this.getLeftArrowClass(), onClick: this.onPageLeft }, this.getLeftArrow()), _react2.default.createElement("div", { className: "references-wrapper" }, referenceToLoad.map(function (reference, key) {
                return _react2.default.createElement("div", { className: "reference-item clear", key: key }, _react2.default.createElement("div", { className: "reference-img-wrapper" }, _react2.default.createElement("img", { className: "reference-image", src: reference.Image, alt: "Reference Head Shot" })), _react2.default.createElement("div", { className: "reference-info" }, _react2.default.createElement("div", { className: "reference-info-padder" }, _react2.default.createElement("div", { className: "reference-name" }, reference.Name), _react2.default.createElement("div", { className: "reference-position" }, reference.Position), _react2.default.createElement("div", { className: "reference-rec" }, reference.Recommendation))));
            })), _react2.default.createElement("div", { className: this.getRightArrowClass(), onClick: this.onPageRight }, this.getRightArrow()));
        }
    }]);
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.renderReferences = function (referenceJson) {
        var references = JSON.parse(referenceJson);
        ...
        _this2.setState({
            ...
            totalPages: Math.ceil(references.peerReferences.length / _this2.state.referencePerPage) // pages to page through
        });
    };
    ...
    this.onPageRight = function () {
        var _state2 = _this2.state,
            page = _state2.page,
            referencesCount = _state2.referencesCount,
            referencePerPage = _state2.referencePerPage,
    ...
    this.getLeftArrow = function () {
        // left arrow svg
        return _react2.default.createElement("svg", { viewBox: "0 0 320 512" }, _react2.default.createElement("path", { fill: "#FFFFFF", d: "M34.52 239.03L228.87 44.69c9.37-9.37 24.57-9.37 33.94 0l22.67 22.67c9.36 9.36 9.37 24.52.04 33.9L131.49 256l154.02 154.75c9.34 9.38 9.32 24.54-.04 33.9l-22.67 22.67c-9.37 9.37-24.57 9.37-33.94 0L34.52 272.97c-9.37-9.37-9.37-24.57 0-33.94z" }));
    };

    this.getRightArrow = function () {
        // right arrow svg
        return _react2.default.createElement("svg", { viewBox: "0 0 320 512" }, _react2.default.createElement("path", { fill: "#FFFFFF", d: "M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z" }));
    };

    this.getLeftArrowClass = function () {
        var page = _this2.state.page;

        var defaultClass = 'reference-pager reference-page-left';
        // sets left arrow class and append disable if on first page
        return page === 1 ? defaultClass + " disable" : defaultClass;
    };

    this.getRightArrowClass = function () {
        var defaultClass = 'reference-pager reference-page-right';
...
var CaseStudies = function (_Component) {
    ...
    function CaseStudies(props) {
        ...
        _this.renderCaseStudies = function (caseJson) {
            var caseStudies = JSON.parse(caseJson);
            _this.setState({
                caseLoaded: true,
        ...
        _this.getDotSvg = function () {
            return _react2.default.createElement("svg", { viewBox: "0 0 512 512" }, _react2.default.createElement("path", { fill: "#0d75c1", d: "M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z" }));
        };
        ...
        xReq.onload = function () {
            if (xReq.readyState === 4) {
                if (xReq.status === 200) {
                    _this.renderCaseStudies(xReq.responseText);
                } else {
                    console.log('status text: ', xReq.statusText);
                }
            }
    ...
    _createClass(CaseStudies, [{
        ...
        value: function render() {
            ...
            var _state = this.state,
                caseLoaded = _state.caseLoaded,
                caseStudyData = _state.caseStudyData;

            if (!caseLoaded) {
                return null;
            }

            return _react2.default.createElement("div", { className: "case-study-container" }, caseStudyData.map(function (parentCase, key) {
                return _react2.default.createElement("div", { className: "case-study-wrapper", key: key }, _react2.default.createElement("div", { className: "case-study-header" }, _react2.default.createElement("div", { className: "case-study-title" }, parentCase.Title), _react2.default.createElement("div", { className: "case-study-title-underline" })), _react2.default.createElement("div", { className: "case-study-item-wrapper clear" }, parentCase.Content.map(function (caseStudy, key) {
                    return _react2.default.createElement("div", { className: "case-study-item", key: key }, _react2.default.createElement("a", { href: caseStudy.Url, className: "case-study-link" }, _react2.default.createElement("div", { className: "case-study-image-wrapper" }, _react2.default.createElement("img", { className: "case-study-img", src: caseStudy.Image, alt: caseStudy.Name })), _react2.default.createElement("div", { className: "case-study-tagline" }, _react2.default.createElement("span", { className: "case-study-name" }, caseStudy.Name), _react2.default.createElement("i", { className: "case-study-tag-break" }, _this2.getDotSvg()), _react2.default.createElement("span", { className: "case-study-type" }, caseStudy.Type))));
                })));
            }));
        }
    }]);
